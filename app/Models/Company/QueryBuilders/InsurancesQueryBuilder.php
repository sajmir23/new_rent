...
class InsurancesQueryBuilder extends Builder
{
    public function search(?string $keyword = null, ?int $id = null): InsurancesQueryBuilder
    {
        // Always restrict results to the authenticated company
