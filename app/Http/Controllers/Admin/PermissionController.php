...
class PermissionController extends Controller
{
    public function index(Request $request){
        ...
        $permissions = Permission::query()->where('scope', 'system')->when($request->general_search_input , function ($query) use ($request){
        ...
        return view('admin.roles_permissions.all_permissions')->with([
    ...
    public function checkUsers(Request $request,$permission_id){
        ...
        return view('admin.roles_permissions.permission_users')->with([
            'roles' => $roles
        ]);
    }

    public function create(){
        return view('admin.roles_permissions.add_permission');
    }
