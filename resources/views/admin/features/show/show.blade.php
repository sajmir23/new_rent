                            ...
                            <div class="card  card-flush h-lg-100">
                                ...
                                <div class="card-header mt-6">
                                    ...
                                    <div class="card-title flex-column">
                                        <h3 class="fw-bold mb-1">Id : {{$feature->id}}

                                        </h3>

                                        <div class="fs-6 text-gray-500">Created Date : {{$feature->created_at}}</div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="d-flex align-items-center mb-5">
                                                ...
                                                <div class="fw-semibold">
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary">Slug</a>
