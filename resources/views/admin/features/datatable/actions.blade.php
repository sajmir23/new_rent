...
<div class="d-flex flex-shrink-0">
    ...
    @if(auth()->user()->hasPermission('features.view_any'))
        <a target="_blank" href="{{route('admin.features.show', $id)}}">
    ...
    <a href="{{route('admin.features.edit',['id' => $id])}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
