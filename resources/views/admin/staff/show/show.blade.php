            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">
                            <a href="{{route('admin.staff.index')}}" class="text-white text-hover-primary">
                                Staff List
                            </a>
                        </li>
                        <li class="breadcrumb-item">
        ...
        <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid ">
                    @include('admin.staff.show.partials.navbar')
                            ...
                            <div class="card card-xl-stretch shadow-sm">
                                ...
                                <div class="card-body pt-5">
                                    <div class="mb-4">
                                        ...
                                        <span class="text-muted">{{ $staff->fullName() }}</span>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <span class="text-muted">{{ $staff->phone_number }}</span>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <span class="text-muted">{{ $staff->notes ?: 'No notes' }}</span>
                                    </div>
                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Status:</strong>
                                        <span class="badge badge-light-{{ $staff->status ? 'success' : 'danger' }}">
                            ...
                            <div class="card card-xl-stretch shadow-sm">
                                ...
                                <div class="card-body pt-5">
                                    <div class="mb-4">
                                        ...
                                        <span class="text-muted">{{ $staff->company->name }}</span>
                                    </div>
                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Email:</strong>
                                        <span class="text-muted">{{ $staff->company->email }}</span>
                                    </div>
                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Phone:</strong>
                                        <span class="text-muted">{{ $staff->company->phone }}</span>
                                    </div>
                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Address:</strong>
                                        <span class="text-muted">{{ $staff->company->address }}</span>
                                    </div>
                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Status:</strong>
                                        <span class="badge badge-light-{{ $staff->company->status ? 'success' : 'danger' }}">
                        {{ $staff->company->status ? 'Active' : 'Inactive' }}
                    </span>
                                    </div>
                                </div>
                            </div>
