        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                ...
                <div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    ...
                    <!--begin:Menu item-->
                    @include('admin.layout.header_partials.dashboards')
                    <!--end:Menu item-->
                    <!--begin:Menu item-->
                    @include('admin.layout.header_partials.management')
                    <!--end:Menu item-->
                    <!--begin:Menu item-->
                    @include('admin.layout.header_partials.system_management')
                    <!--end:Menu item-->
                    <!--begin:Menu item-->
                    @include('admin.layout.header_partials.booking_management')
                    <!--end:Menu item-->
                </div>
                <!--end::Menu-->
            </div>
                        ...
                        <div class="scroll-y mh-325px my-5 px-8">
                            ...
                            <span class="symbol-label bg-light-primary">
                                <i class="ki-outline ki-abstract-28 fs-2 text-primary"></i>
                                        ...
                                        <div class="mb-0 me-2">
                                            <div class="mb-0 me-2">
                                                @if($notification->type === \App\Notifications\ContactFormNotification::class)
                                                    <a href="{{ route('admin.contact_index', $notification->data['contact_id']) }}"
                                                       class="fs-6 text-gray-800 fw-bold text-hover-primary">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        @auth
                            @if(session('impersonated_by'))
                                <!--begin::Menu item -->
                                <div class="menu-item px-5">
                                    <form method="GET" action="{{route('admin.users.leave-impersonate')}}" id="leave-impersonation-form" >
