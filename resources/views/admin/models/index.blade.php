            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">Models List</li>
                    </ul>
                </div>
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    <div class="page-title me-5">
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Models List</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header border-info border-3 d-inline-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div class="btn-group" role="group" aria-label="">
                                ...
                                <a href="{{route('admin.vehicle_model.create')}}" id="new_content" class="btn btn-primary mr-1" title="Clear Filter">
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                ...
                                                <div class="fv-row mb-7 col-12 col-lg-4 fv-plugins-icon-container">
                                                    ...
                                                    <select name="brand_id" id="brand_id" aria-label="Select a Brand"
                                                            data-control="select2" data-placeholder="Select a Brand..."
    ...
    <script>
        ...
        function confirmDeleteAction(){
            ...
            $.ajax({
                ...
                url: '{{route("admin.vehicle_model.destroy")}}',
            }).done(function (data) {
    ...
    <script>
        $(document).ready(function () {
            ...
            let dt = $datatable.DataTable({
                ...
                order: [[1, 'asc']],
                ajax: {
                    url: '{{ route('admin.vehicle_model.index') }}',
                    data: function (d) {
