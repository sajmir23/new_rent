            ...
            <div class="d-flex flex-column flex-row-fluid">
                ...
                <div class="d-flex align-items-center pt-1">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-white fw-bold lh-1">My Profile</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    ...
                    <div class="page-title me-5">
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">My Profile                               <!--begin::Description-->
                            <span class="page-desc text-gray-600 fw-semibold fs-6 pt-3">Update Profile Info</span>
                            <!--end::Description--></h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Page title-->
                            ...
                            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                                ...
                                <div class="card-header pt-7" id="kt_chat_contacts_header">
                                    ...
                                    <div class="card-title">
                                        ...
                                        <h2>Update Profile Info ({{$user->fullName()}})</h2>
                                    </div>
                                    <!--end::Card title-->
                                </div>
                                <!--end::Card header-->
                                ...
                                <div class="card-body pt-5">
                                    <!--begin::Form-->
                                    <form id="store_users_form" class="form" method="POST" action="{{route('admin.account_update',$user->id)}}">
                                        @csrf
                                        {{method_field('PUT')}}
