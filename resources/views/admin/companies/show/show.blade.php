            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid ">
                    ...
                    <div class="row g-6 mb-6">
                        <!--begin::Company Data Card-->
                        <div class="col-xl-6">
                            <div class="card card-xl-stretch shadow-sm">
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="fw-bold text-dark fs-3">Company Information</span>
                                        <span class="text-muted mt-1 fw-semibold fs-6">Basic details about the company</span>
                                    </h3>
                                </div>
                                <div class="card-body pt-5">
                                    ...
                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Main Office:</strong>
                                        <span class="text-muted">{{ $company->city->name ?? ""}}</span>
                                    </div>

                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Booking Fee %:</strong>
                                        <span class="text-muted">{{ $company->booking_fee_percentage ?? 0 }} %</span>
                                    </div>
                                    <div class="mb-4">
                        ...
                        <div class="col-xl-6">
                            <div class="card card-xl-stretch shadow-sm">
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="fw-bold text-dark fs-3">Company Admin</span>
                                        <span class="text-muted mt-1 fw-semibold fs-6">Details about the admin user</span>
                                    </h3>
                                </div>
                                <div class="card-body pt-5">
                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Full Name:</strong>
                                        <span class="text-muted">{{ $admin->first_name }} {{ $admin->last_name }}</span>
                                    </div>
                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Email:</strong>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <span class="text-muted">{{ $admin->phone_number }}</span>
                                    </div>
                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Address:</strong>
                                        <span class="text-muted">{{ $admin->address }}</span>
                                    </div>
                                    <div class="mb-4">
                                        <strong class="d-block text-gray-800">Status:</strong>
                                        <span class="badge badge-light-{{ $admin->status ? 'success' : 'danger' }}">
