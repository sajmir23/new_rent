...
<div class="d-flex flex-shrink-0">
    ...
    @if(auth()->user()->hasPermission('companies.view_any'))
        <a target="_blank" href="{{route('admin.companies.show', $id)}}">
    ...
    <a href="{{route('admin.companies.edit',['id' => $id])}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
