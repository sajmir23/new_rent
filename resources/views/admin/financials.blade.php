...
@section('content')
    <div class="container-fluid">
        <div class="row mb-8 mt-n6">
            <div class="card shadow-sm border text-center py-4 bg-primary text-white mx-auto" style="max-width: 350px;">
                <div class="mb-2">
            ...
            <div class="card shadow-sm border text-center py-4 bg-success-active text-white mx-auto" style="max-width: 350px;" >
                    <div class="mb-2">
                ...
                <div class="card shadow-sm border text-center py-4 bg-warning text-white mx-auto" style="max-width: 350px;">
                    <div class="mb-2">
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="card shadow-sm border text-center py-4 bg-info text-white mx-auto" style="max-width: 350px;">
                    <div class="mb-2">
                        <i class="fas fa-hand-holding-usd fa-2x text-white"></i>
                    </div>
                    <span class="fs-5 fw-semibold">Registered Companies</span>
                    <div class="fs-2 fw-bold mt-2 d-flex justify-content-center align-items-center">€
                        <span data-kt-countup="true" data-kt-countup-value="{{$companiesCount}}">{{ $companiesCount }}</span>
                    </div>
                </div>
...
@section('custom-js')
                <script>
                    ...
                    function loadChartData(period) {
                        ...
                        let url = `/admin/dashboard/financials/chart?period=${period}&year=${year}`;
