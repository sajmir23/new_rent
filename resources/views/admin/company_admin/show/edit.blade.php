            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">
                            <a href="{{route('admin.company_admin.index')}}" class="text-white text-hover-primary">Company Admin List</a>
                        </li>
                        <li class="breadcrumb-item">
                            <i class="ki-outline ki-right fs-7 text-gray-700 mx-n1"></i>
                        </li>
                    ...
                    <div class="row gx-6 gx-xl-9 mt-5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-12">
                                <!--begin::Form-->
                                <form action="{{route('admin.company_admin.update',$company_admin->id)}}" class="ajax-form"  method="post" id="company_admin_store_form">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                                        ...
                                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4">
                                            <span class="fs-2x fw-bold text-gray-800">Update Company Admin #</span>
                                        </div>
                                        <!--end::ref number-->
                                    </div>
                                    <!--begin::Separator-->
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-10 fv-row">
                                                        <input type="search" name="first_name" id="first_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                               value="{{ old('first_name', $company_admin->first_name) }}" placeholder="First Name"/>
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-10 fv-row">
                                                        <input type="search" name="last_name" id="last_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                               value="{{ old('last_name', $company_admin->last_name) }}" placeholder="Last Name"/>
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                    </div>
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-10 fv-row">
                                                        <select name="company_id" id="company_id"
                                                            ...
                                                            <option value="{{ old('company_id', $company_admin->company_id ?? '') }}" selected hidden>
                                                                {{ old('name', $company_admin->company->name ?? 'Select Company') }}
                                                            </option>
                                                        </select>
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                    </div>
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-10 fv-row">
                                                        <input type="tel" name="phone_number" id="phone_number" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                               value="{{ old('phone_number', $company_admin->phone_number) }}" placeholder="Phone"/>
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                    </div>
                                                </div>
                                                <!--end::Input group-->
                                            ...
                                            <div class="col-lg-6 mt-4">
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-10 fv-row">
                                                        <input type="email" name="email" id="email" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                               value="{{ old('email', $company_admin->email) }}" placeholder="Email"/>
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                    </div>
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-10 fv-row">
                                                        <input type="search" name="address" id="address" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                               value="{{ old('address', $company_admin->address ?? '') }}" placeholder="Address"/>
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                    </div>
                                                </div>
                                                <!--end::Input group-->
                                                <div class="mb-8 mt-7">
                                                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                                        ...
                                                        <input class="form-check-input" @if($company_admin->status == true) checked @endif type="checkbox" name="status">
                                                    </label>
                                                </div>
                                                <!--begin::Separator-->
                                                <div class="separator separator-dashed mb-8"></div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-12 fv-row">
                                                           <textarea name="notes" id="notes" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                     placeholder="Notes">{{ old('notes', $company_admin->notes) }} </textarea>
                                                    <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                </div>
                                            </div>
                                            <!--end::Input group-->
