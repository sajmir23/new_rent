            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">Company Admin List</li>
                    </ul>
                </div>
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    <div class="page-title me-5">
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Company Admin List</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="card">
                        <div class="card-header border-info border-3 d-inline-flex flex-column flex-md-row align-items-center justify-content-between">
                            <h4 class="card-title">Company Admin List</h4>
                                            ...
                                            <div class="row">
                                                <div class="fv-row mb-7 col-4 fv-plugins-icon-container">
                                                    ...
                                                    <input type="search" class="form-control form-control-solid search-input"
                                                           name="first_name" id="first_name" placeholder="First Name" aria-label="Name"/>
                                                ...
                                                <div class="fv-row mb-7 col-4 fv-plugins-icon-container">
                                                    ...
                                                    <input type="search" class="form-control form-control-solid search-input"
                                                           name="last_name" id="last_name" placeholder="Last Name" aria-label="Name"/>
                                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                                                </div>
                                                ...
                                                <div class="fv-row mb-7 col-4 fv-plugins-icon-container">
                                                    ...
                                                    <input type="email" class="form-control form-control-solid search-input"
                                                ...
                                                <div class="fv-row mb-7 col-4 fv-plugins-icon-container">
                                                    ...
                                                    <input type="tel" class="form-control form-control-solid search-input"
                                                           name="phone" id="phone" placeholder="Phone" aria-label="Phone"/>
                                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                                                </div>
                                                ...
                                                <div class="fv-row mb-7 col-4 fv-plugins-icon-container">
                                                    ...
                                                    <input type="search" class="form-control form-control-solid search-input"
                                                           name="company" id="company" placeholder="Company" aria-label="Company"/>
                                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="ajax-datatable">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-70px">Company Details</th>
    ...
    <script>
        ...
        function confirmDeleteAction(){
            ...
            $.ajax({
                ...
                url: '{{route("admin.company_admin.destroy")}}',
            }).done(function (data) {
    ...
    <script>
        $(document).ready(function () {
            ...
            let dt = $datatable.DataTable({
                ...
                order: [[1, 'asc']],
                ajax: {
                    url: '{{ route('admin.company_admin.index') }}',
                    data: function (d) {
