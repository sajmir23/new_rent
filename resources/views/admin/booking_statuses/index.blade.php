            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">Booking Status List</li>
                    </ul>
                </div>
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    <div class="page-title me-5">
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Booking Status List</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="card">
                        <div class="card-header border-info border-3 d-inline-flex flex-column flex-md-row align-items-center justify-content-between">
                            <h4 class="card-title">Booking Status List</h4>
                                            ...
                                            <div class="row">
                                                <div class="fv-row mb-7 col-4 fv-plugins-icon-container">
                                                    ...
                                                    <input type="search" class="form-control form-control-solid search-input"
                                                           name="title_en" id="title_en" placeholder="Title" aria-label="Title"/>
    ...
    <script>
        $(document).ready(function () {
            ...
            let dt = $datatable.DataTable({
                ...
                stateSave: true,
                order: [[0, 'asc']],
                ajax: '{{ route('admin.booking_statuses.index') }}',
                deferRender: true,
                columns: [
                    {data: 'id', name: 'id'},
