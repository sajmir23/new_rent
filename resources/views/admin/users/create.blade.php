                ...
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    ...
                    <div class="page-title me-5">
                        ...
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Users                               <!--begin::Description-->
                            <span class="page-desc text-gray-600 fw-semibold fs-6 pt-3">Users Create</span>
                            <!--end::Description--></h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Page title-->
                    ...
                    <div class="row g-7">
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                                ...
                                <div class="card-body pt-5">
                                    <!--begin::Form-->
                                    <form id="store_users_form" class="form" method="POST" action="{{route('admin.users.store')}}">
                                        @csrf
                                        ...
                                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <select name="approved_google_login" id="status" aria-label="Select "
                                                            data-control="select2" data-placeholder="Select ..."
                                                            class="form-select form-select-solid form-select-lg fw-semibold
                                                            @if($errors->first('status')) border-danger @endif ">

                                                        <option value="2" selected >No</option>
                                                        <option value="1" @if(old('approved_google_login') == 1) selected @endif>Yes</option>
