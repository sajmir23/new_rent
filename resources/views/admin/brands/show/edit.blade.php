            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">Brand Details</li>
                    </ul>
                </div>
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    <div class="page-title me-5">
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Brand Details</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid ">
                    @include('admin.brands.show.partials.navbar')
                    ...
                    <div class="row gx-6 gx-xl-9 mt-5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-12">
                                <!--begin::Form-->
                                <form action="{{route('admin.brands.update',$brand->id)}}" class="ajax-form"  method="post" id="brand_store_form">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                                        ...
                                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4">
                                            <span class="fs-2x fw-bold text-gray-800">Update Brand #</span>
                                        </div>
                                        <!--end::ref number-->
                                    </div>
                                    <!--begin::Separator-->
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true">
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                         style="background-image: url('{{ asset('storage/' . $brand->icon) }}');">
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="mb-8 mt-7">
                                                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                                        ...
                                                        <input class="form-check-input" @if($brand->status == true) checked @endif type="checkbox" name="status">
                                                    </label>
                                                </div>
                                            </div>
