...
<div class="d-flex flex-shrink-0">
    ...
    @if(auth()->user()->hasPermission('transmission_types.view_any'))
        ...
        <a target="_blank" href="{{route('admin.transmission_types.show', $id)}}">
    ...
    <a href="{{route('admin.transmission_types.edit',['id' => $id])}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
