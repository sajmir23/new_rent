            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">Transmission Type Details</li>
                    </ul>
                </div>
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    <div class="page-title me-5">
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Transmission Type Details</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid ">
                    @include('admin.transmission_types.show.partials.navbar')
                    ...
                    <div class="row gx-6 gx-xl-9 mt-5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-12">
                                <!--begin::Form-->
                                <form action="{{route('admin.transmission_types.update',$transmission_type->id)}}" class="ajax-form"  method="post" id="transmission_type_store_form">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                                        ...
                                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4">
                                            <span class="fs-2x fw-bold text-gray-800">Update Transmission Type #</span>
                                        </div>
                                        <!--end::ref number-->
                                    </div>
                                    <!--begin::Separator-->
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_en" id="title_en"
                                                               value="{{$transmission_type->title_en}}"
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_it" id="title_it"
                                                               value="{{$transmission_type->title_it}}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_al" id="title_al"
                                                               value="{{$transmission_type->title_al}}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_es" id="title_es"
                                                               value="{{$transmission_type->title_es}}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_fr" id="title_fr"
                                                               value="{{$transmission_type->title_fr}}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_de" id="title_de"
                                                               value="{{$transmission_type->title_de}}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <div class="mb-8 mt-7">
                                                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                                        ...
                                                        <input class="form-check-input" @if($transmission_type->status == true) checked @endif type="checkbox" name="status">
                                                    </label>
                                                </div>
                                            </div>
