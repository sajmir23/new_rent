...
<div class="d-flex flex-shrink-0">
    ...
    @if(auth()->user()->hasPermission('vehicle_categories.view_any'))
        <a target="_blank" href="{{route('admin.vehicle_categories.show', $id)}}">
    ...
    <a href="{{route('admin.vehicle_categories.edit',['id' => $id])}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
