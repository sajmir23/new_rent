                    ...
                    <div class="row gx-6 gx-xl-9 mt-5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-12">
                                <!--begin::Form-->
                                <form action="{{route('admin.vehicle_categories.update',$vehicle_category->id)}}" class="ajax-form"  method="post" id="vehicle_category_store_form">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                                        ...
                                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4">
                                            <span class="fs-2x fw-bold text-gray-800">Update Vehicle Category #</span>
                                        </div>
                                        <!--end::ref number-->
                                    </div>
                                    <!--begin::Separator-->
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true">
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                         style="background-image: url('{{ asset('storage/' . $vehicle_category->icon) }}');">
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_en" id="title_en"
                                                               value="{{$vehicle_category->title_en}}"
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_it" id="title_it"
                                                               value="{{$vehicle_category->title_it}}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_al" id="title_al"
                                                               value="{{$vehicle_category->title_al}}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_es" id="title_es"
                                                               value="{{$vehicle_category->title_es}}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_fr" id="title_fr"
                                                               value="{{$vehicle_category->title_fr}}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="search" name="title_de" id="title_de"
                                                               value="{{$vehicle_category->title_de}}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <div class="mb-8 mt-7">
                                                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                                        ...
                                                        <input class="form-check-input" @if($vehicle_category->status == true) checked @endif type="checkbox" name="status">
                                                    </label>
                                                </div>
                                            </div>
