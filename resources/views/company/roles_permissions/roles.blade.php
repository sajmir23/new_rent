...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
                    ...
                    <div class="col-md-4">
                        <!--begin::Card-->
                            ...
                            <div class="card-footer flex-wrap pt-0">
                                <a href="{{route('company.roles.permissions',$role->id)}}" class="btn btn-light btn-active-primary my-1 me-2">Manage Permissions</a>
                            </div>
                            <!--end::Card footer-->
                        </div>
                        <!--end::Card-->
            ...
            <!--end::Row-->
          @include('company.roles_permissions.modals')
        </div>
        <!--end::Content-->
    </div>
@endsection
