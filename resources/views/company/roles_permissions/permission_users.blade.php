            ...
            <div class="d-flex flex-column flex-row-fluid">
                ...
                <div class="d-flex align-items-center pt-1">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-white fw-bold lh-1">Permissions Users</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    ...
                    <div class="page-title me-5">
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Permissions Users      <!--begin::Description-->
                            <span class="page-desc text-gray-600 fw-semibold fs-6 pt-3">Permission Full Users</span>
                            <!--end::Description--></h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Page title-->
                            ...
                            <div class="d-flex flex-column gap-5">
                                ...
                                @foreach($roles as $role)
                                    <div class="d-flex flex-stack">
                                        <a href="{{route('company.roles.permissions',$role->id)}}" class="fs-6 fw-bold text-gray-800 text-hover-primary text-active-primary active">
                                           {{$role->title}}
                                        </a>
