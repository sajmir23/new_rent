    ...
    <div class="modal-dialog modal-dialog-centered mw-750px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-lg-5 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_role_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{route('company.roles.store')}}">
                    @csrf
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_role_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_role_header" data-kt-scroll-wrappers="#kt_modal_add_role_scroll" data-kt-scroll-offset="300px" style="">
                        ...
                        <div class="fv-row mb-10 fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input class="form-control form-control-solid" required placeholder="Enter a role name" name="role_name">
                            <!--end::Input-->
                        ...
                        <div class="fv-row mb-10 fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input class="form-control form-control-solid" required placeholder="Role Description" name="role_description">
                            <!--end::Input-->
                        ...
                        <div class="fv-row mb-10 fv-plugins-icon-container">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="color" class="form-control form-control-solid" required placeholder="Background Color" name="background_color">
                                    <!--end::Input-->
                                ...
                                <div class="col-6">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="color" class="form-control form-control-solid" required placeholder="Text Color" name="text_color">
                                    <!--end::Input-->
                                            ...
                                            <td>
                                                ...
                                                @foreach($group as $permission)
                                                        ...
                                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                            <input class="form-check-input" type="checkbox" value="{{$permission->id}}" name="new_role_permissions[]">
