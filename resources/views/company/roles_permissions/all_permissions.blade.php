                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="{{ route('company.permissions.create') }}" class="btn btn-light-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach($permission->roles as $role)
                                                    <a href="{{route('company.roles.permissions',$role->id)}}" style="background-color: {{$role->background_color ? : "green"}}; color: {{$role->text_color ? : "white"}}" class="badge fs-7 m-1">{{ucfirst($role->title)}}</a>
                                                @endforeach
                                            ...
                                            <td class="text-end">
                                                <a href="{{route('company.permissions.users',$permission->id)}}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" >
