            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">
                            <a href="{{route('company.tariff.index')}}" class="text-white text-hover-primary">Tariffs</a>
                        </li>
                        <li class="breadcrumb-item">
                            <i class="ki-outline ki-right fs-7 text-gray-700 mx-n1"></i>
                        </li>
                        <li class="breadcrumb-item text-white fw-bold lh-1">Tariffs Details</li>
                    </ul>
                </div>
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    <div class="page-title me-5">
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Tariffs Details</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid ">
                    @include('company.tariff.show.partials.navbar')
                    ...
                    <div class="row gx-6 gx-xl-9 mt-5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-12">
                                <!--begin::Form-->
                                <form action="{{route('company.tariff.update',$tariff->id)}}" class="ajax-form"  method="post" id="tariff_store_form">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                                        ...
                                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4">
                                            <span class="fs-2x fw-bold text-gray-800">Update Tariff #</span>
                                        </div>
                                        <!--end::ref number-->
                                    </div>
                                    <!--begin::Separator-->
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="number" name="min_days" id="min_days"
                                                               value="{{ $tariff->min_days }}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                               placeholder="Min Days"  required/>
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                    </div>
                                                </div>

                                                <div class="row mb-5">
                                                    <label for="max_days" class="col-lg-4 col-form-label fw-semibold fs-6">
                                                        <span>Max Days</span>
                                                    </label>
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="number" name="max_days" id="max_days"
                                                               value="{{ $tariff->max_days }}"
                                                               class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                               placeholder="Max Days" required/>
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                    </div>
                                                </div>
                                                <div class="row mb-5">
