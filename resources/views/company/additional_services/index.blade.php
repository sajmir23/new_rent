                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="card">
                        <div class="card-header border-info border-3 d-inline-flex flex-column flex-md-row align-items-center justify-content-between">
                            <h4 class="card-title">Additional Service list</h4>
                            <div class="btn-group" role="group" aria-label="">
                                @if(auth()->user()->hasPermission('additional_services.store'))
                                    <a href="{{route('company.additional_services.create')}}" id="new_content" class="btn btn-primary mr-1" title="Clear Filter">
                                        <i class="fa fa-plus"></i> Additional Service list
                                    </a>
                                @endif
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="ajax-datatable">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Service Price</th>
    ...
    <script>
        ...
        function confirmDeleteAction(){
            ...
            $.ajax({
                ...
                url: '{{route("company.additional_services.destroy")}}',
            }).done(function (data) {
    ...
    <script>
        $(document).ready(function () {
            ...
            let dt = $datatable.DataTable({
                ...
                order: [[1, 'asc']],
                ajax: {
                    url: '{{ route('company.additional_services.index') }}',
                    data: function (d) {
                        d.title     = $('#title').val();
                    }
                },
