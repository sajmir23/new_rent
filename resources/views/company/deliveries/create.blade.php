            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">New Delivery</li>
                    </ul>
                </div>
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    <div class="page-title me-5">
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">New Delivery</h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-12">
                                    <!--begin::Form-->
                                    <form action="{{ route('company.deliveries.store') }}" class="ajax-form" method="post" id="location_store_form">
                                        @csrf
                                        <!--begin::Wrapper-->
                                        <div class="d-flex flex-column align-items-start flex-xxl-row">
                                            <!--begin::-->
                                            <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4">
                                                <span class="fs-2x fw-bold text-gray-800">New Delivery #</span>
                                            </div>
                                            <!--end::-->
                                        </div>
                                        <!--end::Top-->
                                            ...
                                            <div class="row gx-10 mb-5">
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="search" name="place" id="v" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                   placeholder="Place"/>
                                                            <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="number" name="price" id="price" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                   placeholder="Price"/>
                                                            <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-6">
                                                        <label for="delivery_time" class="col-lg-4 col-form-label fw-semibold fs-6">
                                                            <span>Delivery Time</span> </label>
                                                        <div class="col-lg-8 fv-row">
                                                            <input type="text" name="delivery_time" id="delivery_time" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
