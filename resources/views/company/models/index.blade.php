            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">Model List</li>
                    </ul>
                </div>
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    <div class="page-title me-5">
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Model List</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            let dt = $datatable.DataTable({
                ...
                order: [[1, 'asc']],
                ajax: {
                    url: '{{ route('company.vehicle_model.index') }}',
                    data: function (d) {
    ...
    <script>
        $(document).ready(function () {
            ...
            $brand_id.select2({
                allowClear: true,
                ajax: {
                    url: "{{ route('company.brands.search') }}",
                    dataType: 'json',
                    cache: false,
