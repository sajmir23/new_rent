                        ...
                        <div class="card-header border-info border-3 d-inline-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div class="btn-group" role="group" aria-label="">
                                @if(auth()->user()->hasPermission('company.staff.store'))
                                    <a href="{{route('company.staff.create')}}" id="new_content" class="btn btn-primary mr-1" title="Clear Filter">
    ...
    <script>
        ...
        function confirmDeleteAction(){
            ...
            $.ajax({
                ...
                url: '{{route("company.staff.destroy")}}',
            }).done(function (data) {
