            ...
            <div class="d-flex flex-column flex-row-fluid">
                <div class="d-flex align-items-center pt-1">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <li class="breadcrumb-item text-white fw-bold lh-1">Insurances</li>
                    </ul>
                </div>
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    <div class="page-title me-5">
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Insurance List</h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-header border-info border-3 d-inline-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div class="btn-group" role="group" aria-label="">
                                @if(auth()->user()->hasPermission('insurances.store'))
                                    <a href="{{route('company.insurances.create')}}" id="new_content" class="btn btn-primary mr-1" title="Clear Filter">
                                        <i class="fa fa-plus"></i>New Insurance
                                    </a>
                                @endif
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                ...
                                                <div class="fv-row mb-7 col-12 col-lg-4 fv-plugins-icon-container">
                                                    ...
                                                    <select name="has_theft_protection" id="has_theft_protection" aria-label="Select a Theft Protection"
                                                            data-control="select2" data-placeholder="Select a theft protection..."
                                                ...
                                                <div class="fv-row mb-7 col-12 col-lg-4 fv-plugins-icon-container">
                                                    ...
                                                    <select name="has_deposit" id="has_deposit" aria-label="Select a Deposit"
                                                            data-control="select2" data-placeholder="Select a deposit..."
                                                            class="form-select form-select-solid form-select-lg fw-semibold search-input">
                                                        <option value="1">Yes</option>
                                                        <option value="0">No</option>
                                                    </select>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="ajax-datatable">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Price/Day (€)</th>
                                        <th class="min-w-125px">Theft Protection</th>
                                        <th class="min-w-125px">Theft Protection Price (€) </th>
                                        <th class="min-w-125px">Deposit</th>
                                        <th class="min-w-125px">Deposit Price (€)</th>
    ...
    <script>
        ...
        function confirmDeleteAction(){
            ...
            $.ajax({
                ...
                url: '{{route("company.insurances.destroy")}}',
            }).done(function (data) {
    ...
    <script>
        $(document).ready(function () {
            ...
            let dt = $datatable.DataTable({
                ...
                order: [[1, 'asc']],
                ajax: {
                    url: '{{ route('company.insurances.index') }}',
                    data: function (d) {
                        d.title_en     = $('#title_en').val();
                        d.description_en = $('#description_en').val();
                        d.has_theft_protection  = $('#has_theft_protection').val();
                        d.has_deposit =$('#has_deposit').val();
                    }
                },
                deferRender: true,
                columns: [
                    ...
                    {data: 'has_theft_protection', name: 'has_theft_protection'},
                    {data: 'theft_protection_price', name: 'theft_protection_price'},
                    {data: 'has_deposit', name: 'has_deposit'},
