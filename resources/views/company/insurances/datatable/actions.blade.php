<div class="d-flex flex-shrink-0">
    ...
    @if(auth()->user()->hasPermission('insurances.view_any'))
        <a target="_blank" href="{{route('company.insurances.show', $id)}}">
    ...
    @if(auth()->user()->hasPermission('insurances.update'))
        <a href="{{route('company.insurances.edit',['id' => $id])}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
