            ...
            <div class="d-flex flex-column flex-row-fluid">
                ...
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    <div class="page-title me-5">
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">New Insurance</h1>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="card card-flush h-lg-100">
                                <div class="card-header mt-6">
                                    <div class="card-title flex-column">
                                        <h3 class="fw-bold mb-1">New Insurance</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                @foreach(['en', 'it', 'al', 'es', 'de', 'fr'] as $lang)
                                                    <div class="mb-3">
                                                        <label for="title_{{ $lang }}" class="fw-semibold">Title_{{ $lang }}</label>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                @foreach(['en', 'it', 'al', 'es', 'de', 'fr'] as $lang)
                                                    <div class="mb-3">
                                                        <label for="description_{{ $lang }}" class="fw-semibold">Description_{{ $lang }}</label>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="mb-4 mt-7">
                                                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-3">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" name="has_deposit" id="has_deposit" value="1">
                                                    </label>
                                                </div>

                                                <div class="mb-3" id="deposit_container" style="display: none;">
                                                ...
                                                <div class="mb-4 mt-7">
                                                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" name="has_theft_protection" id="has_theft_protection" value="1">
                                                    </label>
                                                </div>

                                                <div class="mb-3" id="theft_protection_container" style="display: none;">
...
@section('custom-js')
    ...
    <script>
        const checkbox = document.getElementById('has_deposit');
        const depositContainer = document.getElementById('deposit_container');

        checkbox.addEventListener('change', () => {
            depositContainer.style.display = checkbox.checked ? 'block' : 'none';
        });
